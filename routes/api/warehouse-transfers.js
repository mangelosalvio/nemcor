...
const validateInput = require("./../../validators/warehouse-transfers");
...
const Model = WarehouseTransfer;
const seq_key = "wt_no";
const ObjectId = mongoose.Types.ObjectId;

router.get("/:id/print", async (req, res) => {
  await printing_functions.printWarehouseTransfer({ _id: req.params.id });
...
router.post("/paginate", (req, res) => {
  ...
  const form_data = {
    ...
    ...(!isEmpty(advance_search.wt_no) && {
      wt_no: parseInt(advance_search.wt_no),
    }),
    ...
    ...(advance_search.to_warehouse && {
      "to_warehouse._id": ObjectId(advance_search.to_warehouse._id),
    }),
