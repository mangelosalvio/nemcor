...
const ReplacementReceipt = require("./../../models/ReplacementReceipt");
...
const validateInput = require("./../../validators/replacement-receipts");
...
const Model = ReplacementReceipt;
const ObjectId = mongoose.Types.ObjectId;

const seq_key = "replacement_no";
const branch_reference_prefix = "RR";
...
router.put("/", (req, res) => {
  ...
  BranchTransactionCounter.increment(
    ...
    branch_reference = `RR-${branch?.company?.company_code}-${
      branch.name
    ...
    newRecord
      .save()
      .then((record) => {
        const module_name = "Replacement Receipt";
