...
class EndingBalanceForm extends Component {
  state = {
    title: "Ending Balance Form",
    url: "/api/ending-balance/",
    search_keyword: "",
    errors: {},
    ...form_data,
    product_options: [],
  ...
  componentDidMount() {
    this.getCurrentEndingBalance();
  }

  getCurrentEndingBalance = () => {
        ...
        <div className="columns is-marginless">
          <div className="column">
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Ending Balance</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="column">
            <Searchbar
...
export default connect(mapStateToProps)(EndingBalanceForm);
