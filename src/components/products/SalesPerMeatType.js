...
class SalesPerMeatType extends Component {
  state = {
    title: "Products",
    url: "/api/products/",
    search_keyword: "",
  ...
  getReport = () => {
    this.setState(
      ...
      () => {
        ...
        axios
          .post(`/api/inventories/sales-per-meat-type`, form_data)
          .then((response) =>
            this.setState({
        ...
        <div className="columns is-marginless">
          <div className="column">
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Sales per Meat Type</Breadcrumb.Item>
            </Breadcrumb>
          </div>
        </div>
...
export default connect(mapToState)(SalesPerMeatType);
