...
export default function ProductionPrintout({
  match,
  reprint = false,
  duplicate = false,
}) {
    ...
    >
      <div>
        ...
        <Row className="m-t-1">
          ...
          <Col span={8}>
            <span className="ref-number">{state.production_no}</span>
          </Col>
        </Row>
        <Row>
      ...
      <div className="m-t-1">
        <div className="has-text-weight-bold">Consumed Items</div>
        <Table
          size="small"
          dataSource={addKeysToArray([
            ...(state.consumed_items || []),
            {
              ...
              quantity: sumBy(state.consumed_items, (o) => round(o.quantity)),
      ...
      <div className="m-t-1">
        <div className="has-text-weight-bold">Produced Items</div>
        <Table
          size="small"
          dataSource={addKeysToArray([
            ...(state.produced_items || []),
            {
              ...
              quantity: sumBy(state.produced_items, (o) => round(o.quantity)),
