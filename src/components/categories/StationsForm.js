...
import { printer_options } from "../../utils/Options";
import SelectFieldGroup from "../../commons/SelectFieldGroup";

const { Content } = Layout;

const collection_name = "research_categories";
          ...
          {isEmpty(this.state[collection_name]) ? (
            <Form onSubmit={this.onSubmit}>
              ...
              <SelectFieldGroup
                ...
                name="printer"
                key_column="type"
                value={this.state.printer && this.state.printer.type}
                onChange={(index) => {
                  this.setState({
                    printer: printer_options[index],
                  });
                }}
                error={errors.printer && errors.printer.name}
                formItemLayout={formItemLayout}
...
export default connect(mapToState)(StationsForm);
