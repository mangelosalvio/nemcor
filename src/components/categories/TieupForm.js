...
import { markup_options } from "../../utils/Options";
...
class TieupForm extends Component {
  state = {
    title: "Tieup Form",
    url: "/api/tieups/",
    search_keyword: "",
        ...
        <div className="columns is-marginless">
          <div className="column">
            <Breadcrumb style={{ margin: "16px 0" }}>
              ...
              <Breadcrumb.Item>Tieups</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className="column">
            <Searchbar
          ...
          {isEmpty(this.state[collection_name]) ? (
            <Form onSubmit={this.onSubmit}>
              ...
              <RadioGroupFieldGroup
                ...
                name="markup_option"
                onChange={this.onChange}
                error={errors.markup_option}
                value={this.state.markup_option}
...
export default connect(mapToState)(TieupForm);
