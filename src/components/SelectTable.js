  ...
  render() {
    return (
      <div className="container-is-fullheight is-flex flex-column">
        <div
          className="container box container-is-fullheight flex-1 full-width overflow-auto"
          style={{ marginTop: "1rem" }}
        >
          <div className="has-text-centered is-size-3">
            <div className="module-heading">SELECT TABLE TO TRANSFER</div>
            <hr />
          </div>
              ...
              .map((table) => (
                <div
                  ...
                  className={classnames(
                    "table-selection column TableNumber--table-number is-1",
                    {
