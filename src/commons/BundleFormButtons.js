...
import { onUpdateStatus } from "../utils/form_utilities";

import isEmpty from "../validation/is-empty";

export default function BundleFormButtons({
  state,
  auth,
  loading,
  onClose,
  ...
  return (
    <Form.Item className="m-t-1">
      <div className="field is-grouped">
            ...
            <button
              onClick={(e) => {
                ...
                onUpdateStatus({
                  url,
                  state,
                  approval_status: BUNDLED,
                  user: auth.user,
                  update_url: "update-bundle-status",
        ...
        {/* {onClose &&
          !isEmpty(state?._id) &&
          ![STATUS_CLOSED, CANCELLED].includes(
        ...
        {/*         {has_cancel && ![CANCELLED].includes(state.status?.approval_status) && (
          <div className="control">
            <button
